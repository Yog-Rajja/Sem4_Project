  ...
  return (
    ...
    >
      <motion.div whileHover={{ scale: 1.02, y: -2 }} whileTap={{ scale: 0.98 }}>
        <Link
          to={`/goals/${goal.id}`}
          className="block rounded-2xl px-3 py-3 transition-colors hover:bg-surface-muted border border-transparent hover:border-brand-100 hover:shadow-card bg-surface"
        >
